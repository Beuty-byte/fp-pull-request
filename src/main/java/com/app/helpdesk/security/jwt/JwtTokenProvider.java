package com.app.helpdesk.security.jwt;

import com.app.helpdesk.exception.JwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    private List<String> getRoleNames(List<Role> roleList) {
        return roleList.stream().map(Role::toString).collect(Collectors.toList());
    }
}
